public class Vector {
    ...
    private double xArrival;
    private double yArrival;
    private double zArrival;
    ...
    public Vector(Point origin, Point arrival) {

        this.xOrigin = origin.get_X();
        this.yOrigin = origin.get_Y();
        this.zOrigin = origin.get_Z();

        this.xArrival = arrival.get_X();
        this.yArrival = arrival.get_Y();
        this.zArrival = arrival.get_Z();
